...
```{r}
detroitGeocoded <- rbind(detroitGeocoded, geocodedDetroitReDo3)
detroitGeocoded
```
...
ggmap(map) + geom_point(data = geocodedAllDetroit, mapping = aes(x = longitude, y = latitude, color = factor(location)), size = 0.1) + theme(legend.position = "none")
