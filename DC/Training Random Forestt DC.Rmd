...
```{r}
bag <- randomForest(location ~ latitude + longitude + Year + capitalizedPrice, data = modelTrain, ntree = 1000, importance = TRUE)
...
```{r}
fullModel <- randomForest(location ~ latitude + longitude + Year + capitalizedPrice, data = modelData, ntree = 1000, mtry = 2, importance = TRUE)
```
