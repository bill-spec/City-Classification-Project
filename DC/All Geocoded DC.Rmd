...
found <- full %>% filter(!is.na(latitude)) %>% filter( ((latitude > 38.3 & latitude < 40.0) & (longitude > -78.35 & longitude < -76.30)) )
notFound <- full %>% filter(is.na(latitude) | !((latitude > 38.3 & latitude < 40.0) & (longitude > -78.35 & longitude < -76.30)) )
...
found <- DCSecondPassAddress %>% filter(!is.na(latitude)) %>% filter( ((latitude > 38.3 & latitude < 40.0) & (longitude > -78.35 & longitude < -76.30)) )
notFound <- DCSecondPassAddress %>% filter(is.na(latitude) | !((latitude > 38.3 & latitude < 40.0) & (longitude > -78.35 & longitude < -76.30)) )
...
found <- DCThirdPassAddress %>% filter(!is.na(latitude)) %>% filter( ((latitude > 38.3 & latitude < 40.0) & (longitude > -78.35 & longitude < -76.30)) )
notFound <- DCThirdPassAddress %>% filter( is.na(latitude) | !((latitude > 38.3 & latitude < 40.0) & (longitude > -78.35 & longitude < -76.30)) )
